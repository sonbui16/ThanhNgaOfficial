...
const sttBarHeightIpad  = Platform.select({
  ios: ipad ? 90 : 20,
  android: StatusBar.currentHeight,
});
export default {
  ...
  // Button
  buttonFontFamily: 'SourceSansPro-Regular',
  ...
  // toolbarHeight:ipX ?  scale(52 + 35 ) : scale(65),
  toolbarHeight: DeviceInfo.isTablet() ? 90 : 40,
