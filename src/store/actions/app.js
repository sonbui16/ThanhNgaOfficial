...
export const courseMemberShip = (...args) => ({
  type: APP_COURSES_MEMBERSHIP,
  args,
});
...
export const searchCourseMe = (...args) => ({
  type: APP_SEARCH_COURSE_ME,
  args,
});
...
export const addDiscussions = (...args) => ({
  type: APP_ADD_DISCUSSIONS,
  args,
});
...
export const completeLesson = (...args) => ({
  type: APP_COMPLETE_LESSON,
  args,
});
...
export const changeViewSite = (...args) => ({
  type: APP_CHANGE_VIEW_SITE,
  args,
});
